...
package com.gp.spring.springcoreadvanced.autowiring;
...
public class TestPSchema {
	...
	public static void main(String[] args) {
		ApplicationContext ctx = new ClassPathXmlApplicationContext("com/gp/spring/springcoreadvanced/autowiring/config.xml");
