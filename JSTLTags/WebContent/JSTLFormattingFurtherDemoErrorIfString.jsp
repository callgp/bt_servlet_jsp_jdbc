...
formated 3:<fmt:formatNumber  value="${accountBalanceValue}"  type="currency" maxFractionDigits="3" />
formated 4:<fmt:formatNumber  value="${accountBalanceValue}"  type="percent"/>
formated 5:<fmt:formatNumber  value="${accountBalanceValue}"  type="number" pattern="####.##$"/>
